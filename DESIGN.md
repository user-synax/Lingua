...
| Mist             | `#5f7474`                                                                                     | `--color-mist`             | Lightest text tier — captions, metadata, tertiary labels. Use for timestamps, footnotes, and non-essential annotations                                                   |
...
:root {
    ...
    --gradient-halo-gradient: radial-gradient(
        circle,
        rgb(191, 241, 245) 32%,
        rgb(169, 235, 169) 64%,
        rgb(103, 226, 235)
    ...
    --font-matter:
        "Matter", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont,
